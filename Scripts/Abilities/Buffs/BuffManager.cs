...
{
    public static System.Collections.Generic.Dictionary<string, Func<PlayerCharacter, PlayerCharacter, Buff>> Buffs = new()
    {
    ...
    {
        return Buffs.TryGetValue(GUID, out var constructor) ? constructor(creator, target) : null;
    }
}